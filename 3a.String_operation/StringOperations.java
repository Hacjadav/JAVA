...
public class StringOperations {
	    public static void main(String[] args) {
	        ...
	        System.out.println("Substring (4,9): " + sample.substring(4, 9));
	        System.out.println("Substring from index 10: " + sample.substring(10));
	        ...
	        boolean isValid = email.contains("@") && email.startsWith("a") && email.endsWith(".com");
